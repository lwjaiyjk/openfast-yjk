...
public class EncodeDecodeTest extends TestCase {
    ...
    public void testComplexMessage() throws Exception {
        ...
        FileOutputStream fileOutputStream = new FileOutputStream(new File("E://result1.txt"));
        MessageOutputStream out = new MessageOutputStream(fileOutputStream);
    ...
    public void ftestMultipleMessages() {
        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
